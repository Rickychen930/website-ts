...
exports.userData = {
    ...
    academics: [
        {
            ...
            period: "2019 – 2023",
            description: "Bachelor of Computer Science | GPA: 3.83/4.00 | Focused on software engineering, algorithms, data structures, and software development methodologies. Completed capstone project in IoT and computer vision.",
        },
        {
            key: "master",
            icon: "📘",
            ...
            period: "2025 – 2027",
            description: "Master of Artificial Intelligence | Specializing in machine learning, deep learning, and AI applications. Expected graduation in 2027.",
        },
    ],
    certifications: [
        {
    ...
    honors: [
        {
            ...
            date: "Jan 2021",
            description: "Ranked 3rd in a Southeast Asia-wide coding competition. Collaborated in a team to solve advanced algorithmic challenges using C++, Python, and Java under time pressure. Demonstrated strong problem-solving skills and algorithmic thinking.",
        },
        {
            key: "codeforces",
            icon: "⚔️",
            ...
            date: "Ongoing",
            description: "Achieved Specialist rating (1450) with 171 problems solved. Actively participates in contests and algorithmic challenges. Consistently solving problems across various difficulty levels including dynamic programming, graph algorithms, and data structures.",
        },
        {
            key: "kattis",
            icon: "🏆",
            ...
            date: "Ongoing",
            description: "Ranked 5510 globally with a score of 220.4. Ranked among top global programmers. Skilled in C++, Python, and Java. Demonstrates proficiency in competitive programming and algorithmic problem-solving.",
        },
        {
            key: "leetcode",
            icon: "🧱",
            ...
            date: "Ongoing",
            description: "Solved 84+ problems covering data structures, algorithms, and system design. Skilled in C++, Python, and Java. Focused on improving problem-solving efficiency and code optimization.",
        },
    ],
    languages: [
        {
    ...
    projects: [
        ...
        },
        {
            ...
            name: "Kabisa",
            date: "2023",
            description: "An educational app introducing Sundanese script through game-based learning. Designed to preserve traditional language and culture. Presented in academic forums and published in IEEE. Built with Swift and SwiftUI, featuring interactive learning modules, gamification elements, and cultural preservation features. The app helps users learn Sundanese script through engaging gameplay and educational content.",
        },
        {
            key: "lemot",
            icon: "💡",
            name: "L-emot",
            date: "2022",
            description: "A smart lamp controller built with Arduino and custom hardware. Enabled wireless control of lighting through embedded systems and software integration. Demonstrates practical IoT applications in home automation. Features include mobile app control, scheduling, brightness adjustment, and energy monitoring. Integrated Arduino microcontroller with Bluetooth connectivity for seamless device control.",
        },
        {
            key: "markir",
            icon: "🚗",
            name: "M-arkir",
            date: "2022",
            description: "A license plate recognition system using Python and OpenCV. Integrated with Arduino for hardware control, combining C++ and Python to enable real-time image processing and automated response. Built as a university project. Features include real-time video processing, OCR for license plate recognition, database storage, and automated gate control. Demonstrates expertise in computer vision and embedded systems integration.",
        },
        {
            key: "tvplugin",
            icon: "📺",
    ...
    softSkills: [
        {
            ...
            description: "Experienced in collaborative development environments using Agile methodology and Scrum practices. Successfully delivered multiple projects using sprint planning, daily standups, and retrospective meetings. Adaptable to changing requirements and able to work effectively in cross-functional teams.",
        },
        {
            key: "analytical",
            icon: "🧠",
            name: "Analytical Thinking",
            description: "Able to break down complex problems and identify efficient, scalable solutions. Strong foundation in algorithms and data structures. Experienced in analyzing system performance, optimizing code, and making data-driven decisions.",
        },
        {
            key: "adaptability",
            icon: "🔄",
            name: "Adaptability",
            description: "Quick to learn new technologies and adjust to changing project requirements and team dynamics. Successfully transitioned between different tech stacks including iOS development, backend development, and IoT systems. Comfortable working in fast-paced environments.",
        },
        {
            key: "collaboration",
            icon: "🤝",
            name: "Collaboration",
            description: "Strong team player with excellent communication skills and a proactive attitude toward shared goals. Experienced in pair programming, code reviews, and knowledge sharing. Able to work effectively with designers, product managers, and other stakeholders.",
        },
        {
            key: "leadership",
            icon: "👥",
            name: "Leadership",
            description: "Demonstrated leadership in team projects and competitive programming competitions. Able to guide team members, delegate tasks effectively, and ensure project delivery on time. Experience mentoring junior developers and sharing technical knowledge.",
        },
        {
            key: "problem-solving",
            icon: "🔧",
            name: "Problem Solving",
            description: "Strong problem-solving skills demonstrated through competitive programming achievements and real-world project challenges. Able to approach problems from multiple angles and find creative solutions. Experienced in debugging complex systems and optimizing performance.",
        },
    ],
    technicalSkills: [
        {
