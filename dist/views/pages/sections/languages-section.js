...
require("../../../assets/css/languages-section.css");
class LanguageSection extends react_1.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (<card_component_1.default id="language-section" title="Languages">
