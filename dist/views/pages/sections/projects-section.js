...
require("../../../assets/css/projects-section.css");
class ProjectsSection extends react_1.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (<card_component_1.default id="projects-section" title="Projects">
